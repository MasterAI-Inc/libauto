...
CAR_THROTTLE_FORWARD_SAFE_SPEED = STORE.get('CAR_THROTTLE_FORWARD_SAFE_SPEED', 23)
CAR_THROTTLE_REVERSE_SAFE_SPEED = STORE.get('CAR_THROTTLE_REVERSE_SAFE_SPEED', -22)
