...
HEADER_BG_COLOR = hex_to_rgb("#53900f")
HEADER_TXT_COLOR = hex_to_rgb("#1f2605")
CONSOLE_BG_COLOR = hex_to_rgb("#000000")
CONSOLE_TXT_COLOR = hex_to_rgb("#DDDDDD")
CONSOLE_TXT_BG_COLOR = hex_to_rgb("#222222")
BIG_STATUS_COLOR = hex_to_rgb("#ffffff")
BIG_STATUS_BG_COLOR = hex_to_rgb("#323232")
